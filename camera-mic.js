...
navigator.mediaDevices.getUserMedia({
    ...
    navigator.mediaDevices.getUserMedia({
        ...
        html += '<p style="font-family: Courier New; font-size: 25px; color:black;margin-top:20px;">Please go to following pages and remove "WebRTC_UTL_Enregistrement" from blocked-list:</p>';
