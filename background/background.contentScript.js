...
function WebRTC_UTL_Enregistrement_Extension(config) {
    config = config || {
    ...
    return {
        startRecording: function(options, callback) {
            ...
            config.WebRTC_UTL_Enregistrement_Extension = true; // hint for background page
...
(document.head || document.body || document.documentElement).appendChild(script).text = WebRTC_UTL_Enregistrement_Extension.toString() + ';;';
script.remove();
